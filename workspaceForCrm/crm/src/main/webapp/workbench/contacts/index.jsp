            ...
            $("#editBtn").click(function () {
                ...
                if($xz.length==0){
                    ...
                    $.ajax({
                        ...
                        url : "workbench/contacts/getUserManageList.do",
                        data : {
                        ...
                        success : function (data) {
                            ...
                            //处理单条activity
                            $("#edit-loginAct").val(data.a.loginAct);
                            $("#edit-name").val(data.a.name);
                            $("#edit-loginPwd").val(data.a.loginPwd);
                            $("#edit-email").val(data.a.email);
                            $("#edit-expireTime").val(data.a.expireTime);
                            $("#edit-deptno").val(data.a.deptno);
            ...
            $.ajax({
                ...
                success : function (data) {
                    ...
                    $.each(data,function (i,n) {
                        ...
                        html += '<td><a style="text-decoration: none; cursor: pointer;" onclick="window.location.href=\'workbench/usermanage/detail.do?id='+n.id+'\';">'+n.fullname+'</a></td>';
                        html += '<td>'+n.mphone+'</td>';
                        html += '<td>'+n.job+'</td>';
                ...
                <form class="form-horizontal" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10" style="width: 300px;">
                            <select class="form-control" id="edit-loginAct">
                    ...
                    <div class="form-group">
                        <label for="edit-loginPwd" class="col-sm-2 control-label">密码</label>
                        <div class="col-sm-10" style="width: 300px;">
                    ...
                    <div class="form-group">
                        ...
                        <label for="edit-lockState" class="col-sm-2 control-label">是否锁定</label>
                        <div class="col-sm-10" style="width: 300px;">
                            <input type="text" class="form-control" id="edit-lockState">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10" style="width: 300px;">
                            <input type="text" class="form-control time" id="edit-deptno">
                        </div>
                        <label for="edit-createTime" class="col-sm-2 control-label">创建时间</label>
                        <div class="col-sm-10" style="width: 300px;">
                            <input type="text" class="form-control time" id="edit-createTime">
                        </div>
                    </div>

                    <div class="form-group">
                        <label for="edit-createBy" class="col-sm-2 control-label">创建人</label>
                        <div class="col-sm-10" style="width: 81%;">
                            ...
                            -->
                            <input type="text" class="form-control" id="edit-createBy">
            ...
            <div class="modal-body">
                ...
                <form id="activityAddForm" class="form-horizontal" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <label for="create-fullname" class="col-sm-2 control-label">客户姓名<span style="font-size: 15px; color: red;">*</span></label>
                        <div class="col-sm-10" style="width: 300px;">
                    ...
                    <div class="form-group">
                        <label for="edit-clueSource1" class="col-sm-2 control-label">职位</label>
                        <div class="col-sm-10" style="width: 300px;">
    ...
    <div style="width: 100%; position: absolute;top: 5px; left: 10px;">
        ...
        <div class="btn-toolbar" role="toolbar" style="height: 80px;">
            <form class="form-inline" role="form" style="position: relative;top: 8%; left: 5px;">
                ...
                <button type="button" id="searchBtn" class="btn btn-default">联系地址</button>
