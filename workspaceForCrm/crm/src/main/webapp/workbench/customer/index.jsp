			...
			<div style="position: relative;top: 10px;">
				<table class="table table-hover">
					...
					<tbody>
						<tr>
							<td><input type="checkbox" /></td>
							<td><a style="text-decoration: none; cursor: pointer;" onclick="window.location.href='detail.jsp';">广西师范大学科技有限公司</a></td>
							<td>育才路15路</td>
							<td>张三</td>
							<td>高端机器人</td>
                            <td>小艾</td>
                        ...
                        <tr class="active">
                            <td><input type="checkbox" /></td>
                            <td><a style="text-decoration: none; cursor: pointer;" onclick="window.location.href='detail.jsp';">广西师范大学电子有限公司</a></td>
                            <td>育才路15路</td>
                            <td>李四</td>
							<td>新能源</td>
                            <td>小依</td>
                            <td>PCB、IC，连接器，线材等电子物料</td>
                        </tr>
					</tbody>
				</table>
			</div>
